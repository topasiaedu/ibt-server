  ...
  try {
    ...
    const { data: newMessage, error: messageError } = await supabase
      ...
      .insert([{
        ...
        phone_number_id: newPhoneNumbers.find((phone: any) => phone.phone_numbers.wa_id === selectedPhoneNumber).phone_number_id,
    ...
    const { data: updatedContact, error: updateContactError } = await supabase
      .from('contacts')
      .update({ last_contacted_by: newPhoneNumbers.find((phone: any) => phone.phone_numbers.wa_id === selectedPhoneNumber).phone_number_id })
